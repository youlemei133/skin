 ...
 * on 2020/12/9 0009
 * <p>
 * 负责从布局中加载View，仿照AppCompatActivity中的布局加载器实现的
 */
public class SkinLayoutInflater extends AppCompatViewInflater {
    ...
    private static final String LOG_TAG = "SkinLayoutInflater";
     ...
     * 收集皮肤属性
     */
    private void collectAttribute(@NonNull AttributeSet attrs, View view) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attributeValue.startsWith("@")) {
                ...
                if (resId != 0) {
                    SkinAttrHandlerUtils.apply(view, attributeName, resId, true);
                }
            }
        }
    }
